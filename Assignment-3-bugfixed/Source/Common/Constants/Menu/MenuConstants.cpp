...
// Modifed by Dan Lingman 2013-11-09
...
const char* HIGHSCORE_SCREEN_NAME = "Highscore";
const char* SETTINGS_SCREEN_NAME = "Settings";
const char* SPLASH_SCREEN_NAME = "Splash";
const char* PAUSE_SCREEN_NAME = "Pase";
const char* WIN_SCREEN_NAME = "Win";
const char* LOSE_SCREEN_NAME = "Lose";
